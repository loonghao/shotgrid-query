...
# Core data types
DATA_TYPE_ADDRESSING: Final[str] = "addressing"
DATA_TYPE_CHECKBOX: Final[str] = "checkbox"
DATA_TYPE_COLOR: Final[str] = "color"
DATA_TYPE_CURRENCY: Final[str] = "currency"
...
DATA_TYPE_FOOTAGE: Final[str] = "footage"
...
DATA_TYPE_PASSWORD: Final[str] = "password"
DATA_TYPE_PERCENT: Final[str] = "percent"
DATA_TYPE_SERIALIZABLE: Final[str] = "serializable"
DATA_TYPE_STATUS_LIST: Final[str] = "status_list"
DATA_TYPE_SYSTEM_TASK_TYPE: Final[str] = "system_task_type"
DATA_TYPE_TAG_LIST: Final[str] = "tag_list"
...
OPERATOR_TYPE_COMPATIBILITY: Final[dict[str, tuple[str, ...]]] = {
    ...
    OP_CONTAINS: (DATA_TYPE_ADDRESSING, DATA_TYPE_TEXT),
    OP_NOT_CONTAINS: (DATA_TYPE_ADDRESSING, DATA_TYPE_TEXT),
    ...
    OP_NOT_BETWEEN: (DATA_TYPE_CURRENCY, DATA_TYPE_NUMBER),
    OP_IN: (
        DATA_TYPE_ADDRESSING,
        DATA_TYPE_CURRENCY,
        DATA_TYPE_DATE,
    ...
    OP_TYPE_IS: (DATA_TYPE_ADDRESSING, DATA_TYPE_ENTITY, DATA_TYPE_MULTI_ENTITY),
    OP_TYPE_IS_NOT: (DATA_TYPE_ADDRESSING, DATA_TYPE_ENTITY, DATA_TYPE_MULTI_ENTITY),
    OP_NAME_CONTAINS: (DATA_TYPE_ADDRESSING, DATA_TYPE_ENTITY, DATA_TYPE_MULTI_ENTITY, DATA_TYPE_TAG_LIST),
    OP_NAME_NOT_CONTAINS: (DATA_TYPE_ADDRESSING, DATA_TYPE_ENTITY, DATA_TYPE_MULTI_ENTITY, DATA_TYPE_TAG_LIST),
    OP_NAME_IS: (DATA_TYPE_ENTITY,),
}
